(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        root.zui = root.zui || {};
        root.zui.tabs = factory(root.jQuery);
    }
}(this, function ($) {
    'use strict';
    ...
    function initTabs() {
        ...
        $(function () {
            ...
            $('ul.zc-tab--navigation').each(function (element) {
                ...
                var slider_width,
                    ...
                    $indicator = $(this).find('.zc-tab-indicator');

                if ($currentTab.hasClass('active')) {
                    slider_width = $('.zc-tab--slider').innerWidth();
    ...
    function moveSlider($tab_clicked) {
        ...
        var $indicator = $list_parent.find('.zc-tab--slider').children();
